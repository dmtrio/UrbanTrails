...
( function ( ) {
	...
	v1.2.4:
	- added new default categories for directions
		...
		return {
			...
			*/
			addDefaultCategories : function ( )
			{
				...
				this.addCategory ( 
					'29', 
					{ 'en' : 'Enter ferry', 'fr' : 'Entrée du ferry' }, 
					L.divIcon ( { iconSize: [40, 40], iconAnchor: [20, 20], popupAnchor: [0, -20], html : '<div class="Pin-Icon Pin-Category-0029"></div>'}) );
				this.addCategory ( 
					'30', 
					{ 'en' : 'Exit ferry', 'fr' : 'Sortie du ferry' }, 
					L.divIcon ( { iconSize: [40, 40], iconAnchor: [20, 20], popupAnchor: [0, -20], html : '<div class="Pin-Icon Pin-Category-0030"></div>'}) );
				this.addCategory ( 
					'31', 
					{ 'en' : 'Continue', 'fr' : 'Continuer' }, 
					L.divIcon ( { iconSize: [40, 40], iconAnchor: [20, 20], popupAnchor: [0, -20], html : '<div class="Pin-Icon Pin-Category-0031"></div>'}) );
				this.addCategory ( 
					'32', 
					{ 'en' : 'Turn slight left', 'fr' : 'Tourner légèrement à gauche' }, 
					L.divIcon ( { iconSize: [40, 40], iconAnchor: [20, 20], popupAnchor: [0, -20], html : '<div class="Pin-Icon Pin-Category-0032"></div>'}) );
				this.addCategory ( 
					'33', 
					{ 'en' : 'Turn left', 'fr' : 'Tourner à gauche' }, 
					L.divIcon ( { iconSize: [40, 40], iconAnchor: [20, 20], popupAnchor: [0, -20], html : '<div class="Pin-Icon Pin-Category-0033"></div>'}) );
				this.addCategory ( 
					'34', 
					{ 'en' : 'Turn sharp left', 'fr' : 'Tourner fort à gauche' }, 
					L.divIcon ( { iconSize: [40, 40], iconAnchor: [20, 20], popupAnchor: [0, -20], html : '<div class="Pin-Icon Pin-Category-0034"></div>'}) );
				this.addCategory ( 
					'35', 
					{ 'en' : 'Turn slight right', 'fr' : 'Tourner légèrement à droite' }, 
					L.divIcon ( { iconSize: [40, 40], iconAnchor: [20, 20], popupAnchor: [0, -20], html : '<div class="Pin-Icon Pin-Category-0035"></div>'}) );
				this.addCategory ( 
					'36', 
					{ 'en' : 'Turn right', 'fr' : 'Tourner à droite' }, 
					L.divIcon ( { iconSize: [40, 40], iconAnchor: [20, 20], popupAnchor: [0, -20], html : '<div class="Pin-Icon Pin-Category-0036"></div>'}) );
				this.addCategory ( 
					'37', 
					{ 'en' : 'Turn sharp right', 'fr' : 'Tourner fort à droite' }, 
					L.divIcon ( { iconSize: [40, 40], iconAnchor: [20, 20], popupAnchor: [0, -20], html : '<div class="Pin-Icon Pin-Category-0037"></div>'}) );
				this.addCategory ( 
					'38', 
					{ 'en' : 'Bike node', 'fr' : 'Point noeud vélo' }, 
					L.divIcon ( { iconSize: [40, 40], iconAnchor: [20, 20], popupAnchor: [0, -20], html : '<div class="Pin-Icon Pin-Category-0038"></div>'}) );
			},
